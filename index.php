        ...
        <div class="container">
            ...
            <div class="row">
                ...
                while ($r = mysqli_fetch_array($query_res)) {
                    ...
                    $discount_query = mysqli_query($db, "SELECT discount FROM restaurant WHERE rs_id = '$res_id'");
                    $discount_data = mysqli_fetch_array($discount_query);
                    $discount = isset($discount_data['discount']) ? $discount_data['discount'] : 0;

                    $discounted_price = $r['price'] - ($r['price'] * ($discount / 100));
        ...
        <div class="food-item-wrap">
            ...
            <div class="content">
                ...
                <div class="price-btn-block"> 
                    ...
                    if ($discount > 0) {
                        echo '<span class="original-price"> <s>₹' . $r['price'] . '</s> </span>';
        ...
        <div class="container">
            ...
            <div class="bottom-footer">
                <div class="row">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d658.1246971996849!2d72.82407571303834!3d21.235369057421156!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04f0068b167ad%3A0x42171362021a4a86!2sO.F.O.S!5e1!3m2!1sen!2sin!4v1731156088508!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
