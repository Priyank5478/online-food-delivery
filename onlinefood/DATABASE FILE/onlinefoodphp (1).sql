...
--
DROP DATABASE IF EXISTS onlinefoodphp;
...
(1, 'admin', 'CAC29D7A34687EB14B37068EE4708E7B', 'admin@mail.com', '');
...
(1, 'John Doe', 1234567890, 'johndoe@example.com', 'active'),
(2, 'Jane Smith', 2147483647, 'janesmith@example.com', 'inactive'),
(3, 'Michael Johnson', 2147483647, 'michaelj@example.com', 'disabled'),
(4, 'Sarah Brown', 2147483647, 'sarahbrown@example.com', 'active'),
(5, 'David Williams', 2147483647, 'davidw@example.com', 'inactive');
...
(13, 6, 'closed', 'asdf', '2024-11-03 14:47:43'),
(14, 6, 'closed', 'asdf', '2024-11-03 14:48:02'),
(15, 6, 'closed', 'asdf', '2024-11-03 14:48:12'),
(16, 14, 'closed', 'asdfasdf', '2024-11-03 14:54:55'),
(17, 22, 'closed', 'test', '2024-11-03 16:06:38'),
(18, 22, 'in process', 'asdasdasdasdasd', '2024-11-05 16:40:44'),
(22, 22, 'closed', 'xzcxzcxzc', '2024-11-05 16:57:47'),
(24, 22, 'closed', 'dsdsfs', '2024-11-05 17:02:51'),
(26, 22, 'closed', 'asdsadsad', '2024-11-05 17:06:08'),
(32, 22, 'closed', 'dsad', '2024-11-05 17:27:41'),
(33, 23, 'closed', 'v', '2024-11-05 18:15:04'),
(34, 24, 'in process', 'dsadsad', '2024-11-05 18:21:22'),
(35, 25, 'closed', 'xsdsd', '2024-11-06 16:37:03'),
(36, 25, 'closed', 'sda', '2024-11-06 16:48:13');
...
INSERT INTO `restaurant` (`rs_id`, `c_id`, `title`, `email`, `phone`, `url`, `o_hr`, `c_hr`, `o_days`, `address`, `image`, `discount`) VALUES
(1, 0, 'North Street Tavern', 'nthavern@mail.com', '3547854700', 'www.northstreettavern.com', '--Select your Hours--', '--Select your Hours--', '--Select your Days--', ' 1128 North St, White Plains ', '67279828db294.png', 10),
(2, 2, 'Eataly', 'eataly@gmail.com', '0557426406', 'www.eataly.com', '11am', '9pm', 'Mon-Sat', '800 Boylston St, Boston', '606d720b5fc71.jpg', 0),
(3, 3, 'Nan Xiang Xiao Long Bao', 'nanxiangbao45@mail.com', '1458745855', 'www.nanxiangbao45.com', '9am', '8pm', 'mon-sat', 'Queens, New York', '6290860e72d1e.jpg', 0),
(4, 4, 'Highlands Bar & Grill', 'hbg@mail.com', '6545687458', 'www.hbg.com', '7am', '8pm', 'mon-sat', '812 Walter Street', '6290af6f81887.jpg', 0),
(5, 0, 'jhjhjhhj', 'tesd@gmzail.com', '1234567891', 'http://localhost/OnlineFood-PHP/admin/add_restaurant.php', '--Select your Hours--', '--Select your Hours--', '--Select your Days--', ' kjjjjj ', '6727a349ece70.png', 5);
...
(1, 'eric', 'Eric', 'Lopez', 'eric@mail.com', '1458965547', 'a32de55ffd7a9c4101a0c5c8788b38ed', '87 Armbrester Drive', 1),
(2, 'harry', 'Harry', 'Holt', 'harryh@mail.com', '3578545458', 'bc28715006af20d0e961afd053a984d9', '33 Stadium Drive', 1),
(3, 'james', 'James', 'Duncan', 'james@mail.com', '0258545696', '58b2318af54435138065ee13dd8bea16', '67 Hiney Road', 1),
(4, 'christine', 'Christine', 'Moore', 'christine@mail.com', '7412580010', '5f4dcc3b5aa765d61d8327deb882cf99', '114 Test Address', 1),
(5, 'scott', 'Scott', 'Miller', 'scott@mail.com', '7896547850', '5f4dcc3b5aa765d61d8327deb882cf99', '63 Charack Road', 1),
(6, 'liamoore', 'Liam', 'Moore', 'liamoore@mail.com', '7896969696', '5f4dcc3b5aa765d61d8327deb882cf99', '122 Bleck Street', 1),
(7, 'test', 'test', 'test', 'test@gmail.com', '1234567890', 'e10adc3949ba59abbe56e057f20f883e', 'test\r\n', 1),
(8, 'testing', 'testing', 'testing', 'testtt@gmail.com', '1234567980', 'ae2b1fca515949e5d54fb22b8ed95575', 'testing', 1);
...
INSERT INTO `users_orders` (`o_id`, `u_id`, `res_id`, `title`, `quantity`, `price`, `status`, `o_otp`) VALUES
(22, 8, 0, 'Yorkshire Lamb Patties', 1, '12.60', 'closed', 0),
(23, 8, 0, 'Lobster Thermidor', 1, '32.40', 'closed', 0),
(24, 8, 0, 'Lobster Thermidor', 1, '32.40', 'in process', 0),
(25, 9, 0, 'Yorkshire Lamb Patties', 2, '12.60', 'closed', 0),
(26, 10, 0, 'Yorkshire Lamb Patties', 1, '12.60', 'closed', 0),
(27, 11, 0, 'Crispy Chicken Strips', 1, '8.00', 'rejected', 0),
(28, 11, 0, ' Buffalo Wings', 3, '11.00', 'closed', 0),
(29, 11, 0, 'Pink Spaghetti Gamberoni', 1, '21.00', NULL, 0),
(30, 11, 0, 'Cheesy Mashed Potato', 1, '5.00', 'closed', 0);
...
--
ALTER TABLE `users`
  MODIFY `u_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `users_orders`
--
ALTER TABLE `users_orders`
  MODIFY `o_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
COMMIT;
