                        ...
                        <div class="collapse in" id="popular2">
                            ...
                            if (!empty($products)) {
                                foreach ($products as $product) {
                                    ...
                                    $discounted_price = $product['price'] - ($product['price'] * ($discount_value / 100));

                            ?>
                                    <div class="food-item">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-lg-8">
                                                <form method="post" action='dishes.php?res_id=<?php echo htmlspecialchars($_GET['res_id']); ?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                                    <div class="rest-logo pull-left">
                                                        <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/dishes/' . htmlspecialchars($product['img']) . '" alt="Food logo">'; ?></a>
                                                    </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                                <?php if ($discount_value > 0) { ?>
                                                    <div class="original-price-container">
                                                        <span class="original-price"><s>₹<?php echo number_format($product['price'], 2); ?></s></span>
                                                        <span class="discount">(<?php echo $discount_value; ?>% OFF)</span>
                                                    </div>
                                                <?php } ?>
                                                <div>
                                                    <span class="price pull-left">₹<?php echo number_format($discounted_price, 2); ?></span>
                                                    <input class="b-r-0" type="number" name="quantity" style="margin-left:30px; width:50px" min="0" value="1" size="2" />
                                                    <input type="submit" class="btn theme-btn-dash pull-right" style="margin-top:10px" value="Add To Cart" />
                                                </div>
                                            </div>
                                            </form>
                                        </div>
